...
| **Bootstrap secret / activation material** | Short-lived secret used only to activate and provision a Device credential. | Segredo temporário usado somente para ativar e provisionar a credencial de um Device. |
